...
- Build & Deploy: `scripts/Build-Mod.ps1` und `scripts/Deploy-Mod.ps1` verwenden (werden beim Setup erstellt). Immer Scripts nutzen, nie rohes `dotnet build` in CLAUDE.md.
